...
class Preprocessor(IPresprocessor):
    ...
    def validate_data(cls) -> bool:
        ...
        if worked_day is None:
            ...
            return False
        print("Follow the frame structure")
    ...
    def _worked_day(cls) -> list:
        ...
        for day in range(1, num_days-1):
            worked_day.append(cls.data[comma_index[day-1]+1:comma_index[day]])

        day_last = cls.data[comma_index[-1]+1:]
...
if __name__ == "__main__":
    ...
    Preprocessor.load_data(TRAMAS).validate_data()
